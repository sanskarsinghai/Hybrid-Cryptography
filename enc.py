...
def aesenc():
    ...
    f=open("templates\CryptoCode\F2\BinfileName11.bin")
    plaintext=''
    for i in f:
        plaintext+=i
    f.close()
    ...
    f2=open('templates\CryptoCode\F2\BinfileName11.bin','wb')
    f2.write(ciphertext)
...
def desenc():
    ...
    f=open("templates\CryptoCode\F2\BinfileName12.bin")
    ...
    f2=open('templates\CryptoCode\F2\BinfileName12.bin','wb')
    f2.write(e)
...
def rc4enc():
    ...
    f=open("templates\CryptoCode\F2\BinfileName13.bin")
    ...
    f2=open('templates\CryptoCode\F2\BinfileName13.bin','wb')
    f2.write(cipher)
...
def stegnoimg(k,iv,di,r,l,imn,nimn):
    ...
    lo="templates\\CryptoCode\\UploadF\\"+imn

    secret = lsb.hide(lo,c)
    
    loc="templates\\CryptoCode\\encFile\\"+nimn+".png"
    secret.save(loc)
